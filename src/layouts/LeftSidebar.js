...
import logolight from './loglight.png';
import logosm from './logosm.png';
import logodarksm from './logodarksm.png';
            ...
            {!hideUserProfile && (
                <div className="leftbar-user">
                    <Link to="/">
                        ...
                        <span className="leftbar-user-name">{adminname}</span>
                    </Link>
                </div>
            )}
                    ...
                    <React.Fragment>
                        <Link to="/" className="logo text-center logo-light">
                            <span className="logo-lg">
                                <img src={isLight ? logodark : logolight} alt="logo" height="40" />
                            </span>
                            <span className="logo-sm">
                                <img src={isLight ? logodarksm : logosm} alt="logo" height="30" />
                            </span>
                        </Link>
