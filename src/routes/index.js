...
const AdminLogin = React.lazy(() => import('../pages/account/adminlogin'));
...
const AddDoctor = React.lazy(() => import('../pages/Doctor/AddDoctor'))
const EditDoctor = React.lazy(() => import('../pages/Doctor/EditDoctor'));
const AddMemberShip = React.lazy(() => import('../pages/Doctor/AddMembership'));

//patient
const Patient = React.lazy(() => import('../pages/Patient/Patient'));
const AddPatient = React.lazy(() => import('../pages/Patient/AddPatient'));
const Transaction = React.lazy(() => import('../pages/Patient/Transaction'));
const Insurances = React.lazy(() => import('../pages/Patient/PatientInsurances'));
const AddInsurances = React.lazy(() => import('../pages/Patient/AddInsurance'));
...
const AddAppointment = React.lazy(() => import('../pages/Appointment/AddAppointment'));
const EditAppointment = React.lazy(() => import('../pages/Appointment/EditAppointment'));

//category
const Dentis = React.lazy(() => import('../pages/Category/dentis'));
const Neurologist = React.lazy(() => import('../pages/Category/neurologist'));
...
//expert
const Expert = React.lazy(() => import('../pages/Category/Expert'));
const AddExpert = React.lazy(() => import('../pages/Category/AddExpert'));
const EditExpert = React.lazy(() => import('../pages/Category/EditExpert'));
// root routes

const rootRoute = {
    path: '/',
    exact: true,
    component: () => <Redirect to="/pages/doctor" />,
    route: PrivateRoute,
};
...
const pageRoutes = {
    ...
    children: [
        ...
        {
            path: '/pages/insurances',
            name: 'Insurances',
            component: Insurances,
            route: PrivateRoute,
        },
        {
            path: '/pages/addinsurances',
            name: 'AddInsurances',
            component: AddInsurances,
            route: PrivateRoute,
        },
        {
            path: '/pages/editpatient',
            name: 'Editpatient',
        ...
        {
            path: '/pages/addexpert',
            name: 'AddExpert',
            component: AddExpert,
            route: PrivateRoute,
        },
        {
            path: '/pages/editexpert',
            name: 'EditExpert',
